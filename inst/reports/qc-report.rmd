...
XY diff = `r qc.summary$parameters$sex.cutoff`. Mismatched samples are shown in red. The dashed lines represent `qc.summary$parameters$sex.outlier.sd` SD from  the mean xy difference. Samples that fall in this interval are denoted as outliers.
...
Distributions of SNP probe beta values are used to determine the quality of the snp probe and should show 3 peaks, one for each genotype probability. Plots should show 
```{r,message=FALSE}
