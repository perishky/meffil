...
```{r}
print(object.size(norm.meffil.1$qc.objects), units="Mb")
print(object.size(norm.meffil.1$norm.objects), units="Mb")
print(object.size(norm.meffil.1), units="Mb")
print(object.size(norm.minfi), units="Mb")
print(object.size(raw.minfi), units="Mb")
```

```{r}
print(object.size(data$norm.objects), units="Mb")
