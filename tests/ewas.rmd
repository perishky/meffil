...
```{r}
idx <- sample(order(ewas.ret$analyses$sva$table$p.value)[1:1000],100)
...
```{r}
meffil.ewas.bedgraph(ewas.ret, "ewas/sva.bed", "sva", name="ga", description=ewas.study)
...
meffil.ewas.bedgraph(ewas.ret, "ewas/sva-custom.bed", "sva", header=header)
meffil.ewas.bedgraph(ewas.ret, "ewas/sva-minimal.bed", "sva")                    
```
