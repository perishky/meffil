...
If the data was generated by multiple array platforms (e.g. 450k, EPIC v1 and and EPIC v2), then `meffil.qc()` should be 'warned' by saying what combination to expect by setting the `featureset` parameter to one of:
"450kepic" (i.e. 450k and EPIC v1), "450kepic2", "epicepic2" (i.e. EPIC v1 and v2), "450kepicepic2" (i.e. 450k, EPIC v1, EPIC v2). *Note that normalizing data from multiple platforms has not be well-studied, so outputs should be interpreted with caution.*
