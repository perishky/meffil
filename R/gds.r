...
#' @param sites Names of CpG sites to retrieve (Default: NULL).
#' @param samples Names of samples to retrieve (Default: NULL).
...
#'
#' @export
meffil.retrieve.methylation <- function(gds.filename, sites=NULL, samples=NULL) {
